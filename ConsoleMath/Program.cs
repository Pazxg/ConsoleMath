...
using System.Text.RegularExpressions;
...

    {
        public static void Main()
        {
            ...
            InputExDisplay();  //get ex disp.(A)
            ResultDisplay();   //get result. (B)
            Console.ReadKey(); //Wait see for result.
        ...
        private static void InputExDisplay()
        {
            ...
            Console.WriteLine($"Max Sum of Non-Prime : {MaxSum}");
    ...
    //Organize define.
        ...
        private static string TriangleInput()
        {
            const string triInput =
                                     @"215
						           	193 124
		  				           117 237 442
                                 218 935 347 235
